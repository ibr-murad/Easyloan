...
struct RequestFullViewModel {
    ...
    init(request: RequestFullModel) {
        ...
        self.actualAddress = request.actualAddress ?? ActualAddressModel(city: "346518264", street: "")
        ...
        self.loanPurpose = request.loanPurpose ?? 3534170730
        self.loanPurposeComment = request.loanPurposeComment ?? ""
        self.loanAmount = request.loanAmount ?? 0
        self.loanTerm = request.loanTerm ?? 0
        self.loanCurrency = request.loanCurrency ?? 3534157618
        self.paymentType = request.paymentType ?? 487876900
